...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const personalAboutMe = {
    ...
    headshot:
      "https://iibamblue.github.io/DarienSCSSPortfolio/src/img/profileAvatar.png",
  };

  fetch("./src/data/aboutMeData.json")
    .then((res) => {
    ...
    .then((data) => {
      ...
      // Use the personal headshot URL directly
      img.src = aboutData.headshot;
      img.alt = "Headshot";
  ...
  // Personal Projects Data (OVERRIDE existing data)
  const personalProjects = [
    {
      project_id: "project_personal_website",
      project_name: "Personal Website",
      short_description:
        "A personal website showcasing my portfolio and skills.",
      long_description:
        "A comprehensive portfolio website built with modern web technologies, showcasing my development skills and project portfolio. Features responsive design, interactive elements, and clean, professional presentation of my work and experience.",
      card_image: "../images/personal_site_card.webp",
      spotlight_image: "../images/personal_site_spotlight.webp",
      url: "https://iibamblue.github.io/DarienSCSSPortfolio/",
    },
    {
      ...
      long_description:
        "WTWR (What to Wear Right Now) is a dynamic React application designed to help users choose the perfect outfit based on current weather conditions. Features real-time weather data integration, user authentication, and personalized clothing recommendations.",
      card_image: "../images/weather_app_card.webp",
      spotlight_image: "../images/weather_app_spotlight.webp",
      url: "https://github.com/iiBamBlue/se_project_react",
    },
    {
      project_id: "project_darien_spots",
      project_name: "Spots Platform",
      short_description: "Responsive social media platform with modern design.",
      long_description:
        "Spots is a responsive social media platform built with modern web technologies. Features include interactive modals, responsive layouts for all devices, and optimized performance with Webpack bundling.",
      card_image: "../images/social_media_card.webp",
      spotlight_image: "../images/social_media_spotlight.webp",
      url: "https://iibamblue.github.io/se_project_spots/",
    },
    {
    ...
    },
    {
      ...
      long_description:
        "A clean, responsive task management app built with vanilla JavaScript. Features form validation, unique task IDs, and real-time updates with a smooth user experience.",
      card_image: "../images/todo_card.webp",
      spotlight_image: "../images/todo_spotlight.webp",
      url: "https://iibamblue.github.io/se_project_todo-app/",
    },
  ];
  ...
  fetch("./src/data/projectsData.json")
    ...
    .then((projects) => {
      // Use personal projects instead of original data (OVERRIDE)
      const allProjects = personalProjects; // Replace with your projects only
      ...
      const getCardImg = (img) => {
        if (!img) return "./src/images/card_placeholder_bg.webp";
        if (img.startsWith("../")) return "./src/" + img.substring(3);
        return img;
      };
      const getSpotlightImg = (img) => {
        if (!img) return "./src/images/spotlight_placeholder_bg.webp";
        if (img.startsWith("../")) return "./src/" + img.substring(3);
        return img;
      };
      ...
      function updateSpotlight(proj) {
        ...
        // Create a container for all text content with background
        const textContainer = document.createElement("div");
        textContainer.style.background = "rgba(228, 216, 204, 0.7)";
        textContainer.style.padding = "20px";
        textContainer.style.borderRadius = "10px 10px 0 0";
